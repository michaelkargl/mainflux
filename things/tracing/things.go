...
func (trm thingRepositoryMiddleware) RetrieveAll(ctx context.Context, owner string, offset, limit uint64, name string, metadata map[string]interface{}) (things.ThingsPage, error) {
