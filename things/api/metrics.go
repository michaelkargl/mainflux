...
func (ms *metricsMiddleware) ListThings(ctx context.Context, token string, offset, limit uint64, name string, metadata map[string]interface{}) (things.ThingsPage, error) {
	defer func(begin time.Time) {
